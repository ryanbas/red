...
user_agent = [('User-Agent', 'python:com.github.ryanbas.red:v0.0.1 (by /u/ryanbas)')]
...
def fetch_newest_posts_from_subreddit(subreddit, after = ''):
...
if args.use_cache:
  ...
  posts_stream = fetch_newest_posts_from_subreddit(subreddit)
